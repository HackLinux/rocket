...
// question:
// what happends when ecc error, pause resps to s1?
// what happends when replay? how does core handle it?
// what is the operation of LR and SC?
// what exactly is doNarrowRead?
